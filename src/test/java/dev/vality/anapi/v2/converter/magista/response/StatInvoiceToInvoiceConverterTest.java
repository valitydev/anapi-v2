...
class StatInvoiceToInvoiceConverterTest {
    ...
    @Test
    void convert() {
        StatInvoiceResponse magistaResponse = MagistaUtil.createSearchInvoiceAllResponse();
        ...
        magistaInvoice.getCart().getLines().get(0).setMetadata(Map.of("TaxMode", Value.str("10%")))
                .setQuantity(RandomUtil.randomInt(1, 10000))
                .setPrice(new Cash()
                        .setAmount(RandomUtil.randomInt(0, 1000000)));
    ...
    void mapStatusInfo() {
        ...
        InvoiceStatus status = InvoiceStatus.fulfilled(new InvoiceFulfilled()
                .setDetails(RandomUtil.randomString(10)));
